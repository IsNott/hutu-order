 ...
 */
@Service
public class BizItemSkuRelationService extends ServiceImpl<BizItemSkuRelationMapper, BizItemSkuRelation> {

    @Resource
    private BizSkuCatalogService bizSkuCatalogService;
    @Resource
    private BizSkuItemService bizSkuItemService;

    @Resource
    private BizSkuCatalogRelationService bizSkuCatalogRelationService;
